      ...
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-lg">
        ...
        >
          ...
          <label className="grid gap-1.5">
            ...
            <select
              className="h-8 w-full rounded-lg border border-input bg-card px-2.5 text-sm text-foreground outline-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 [&>option]:bg-popover [&>option]:text-popover-foreground"
              value={contactType}
